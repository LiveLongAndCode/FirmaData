...
internal static class ResultExtensions
{
    ...
    // has no data, IndustryCodeNotSupported means the code itself is a DB07/DB25 classification
    // mismatch, and any other failure means the source itself was unreachable.
    public static EnrichmentStatus ToStatus(this Result<IndustryStatistics> result) => result switch
    {
        ...
        { Error.Type: ResultErrorType.IndustryCodeNotSupported } => EnrichmentStatus.IndustryCodeNotSupported,
